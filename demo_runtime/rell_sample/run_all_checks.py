...
def main() -> None:
    ...
    run_python("validate_water_delivery_loop.py")
    ...
    run_python("validate_rell_between_beside_language.py")
    ...
    run_python("validate_rell_relative_spatial_execution.py")
    run_python("validate_rell_front_behind_between_execution.py")
    ...
    run_python("validate_relation_hypothesis_architecture.py")
