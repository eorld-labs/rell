...
from runtime_core import run_runtime_sample, run_simulated_runtime_sample, write_json
...
def main() -> None:
    ...
    for scenario, timeline in SCENARIOS.items():
        ...
        write_result(scenario, result, summaries)
...
def write_result(scenario: str, result: dict, summaries: dict) -> None:
